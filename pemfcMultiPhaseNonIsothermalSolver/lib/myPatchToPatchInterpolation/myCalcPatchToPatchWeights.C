...
scalar myPatchToPatchInterpolation<FromPatch, ToPatch>::projectionTol_ = 0.05;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<class FromPatch, class ToPatch>
void myPatchToPatchInterpolation<FromPatch, ToPatch>::calcPointAddressing() const
{
...
template<class FromPatch, class ToPatch>
void myPatchToPatchInterpolation<FromPatch, ToPatch>::calcFaceAddressing() const
{
