...
namespace Foam
{
    ...
    {
        defineTypeNameAndDebug(myFixedCoeff, 0);
        addToRunTimeSelectionTable(myPorosityModel, myFixedCoeff, mesh);
    }
}
...
void Foam::myPorosityModels::myFixedCoeff::apply
(
    scalarField& Udiag,
    vectorField& Usource,
    const scalarField& V,
...
Foam::myPorosityModels::myFixedCoeff::myFixedCoeff
(
    const word& name,
...
void Foam::myPorosityModels::myFixedCoeff::calcTransformModelData()
{
...
void Foam::myPorosityModels::myFixedCoeff::calcForce
(
...
void Foam::myPorosityModels::myFixedCoeff::correct
(
    fvVectorMatrix& UEqn
) const
{
...
bool Foam::myPorosityModels::myFixedCoeff::writeData(Ostream& os) const
{
