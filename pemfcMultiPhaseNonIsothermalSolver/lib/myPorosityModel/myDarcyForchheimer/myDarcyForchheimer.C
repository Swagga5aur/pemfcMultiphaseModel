...
namespace Foam
{
    ...
    {
        defineTypeNameAndDebug(myDarcyForchheimer, 0);
        addToRunTimeSelectionTable(myPorosityModel, myDarcyForchheimer, mesh);
    }
}
...
Foam::myPorosityModels::myDarcyForchheimer::myDarcyForchheimer
(
    const word& name,
...
void Foam::myPorosityModels::myDarcyForchheimer::calcTransformModelData()
{
...
void Foam::myPorosityModels::myDarcyForchheimer::calcForce
(
...
void Foam::myPorosityModels::myDarcyForchheimer::correct
(
    fvVectorMatrix& UEqn
) const
{
    ...
    if (UEqn.dimensions() == dimForce)
    {
        ...
        // disabled so that nu is not called by abp and cbp (J. P. Kone, 12.09.2016)
        /*else
        {
...
bool Foam::myPorosityModels::myDarcyForchheimer::writeData(Ostream& os) const
{
